...
class MyFrame(wx.Frame):
    def __init__(self, parent, title):
        ...
        self.destination = wx.TextCtrl(self.panel, pos=(10, 40), size=(500, 25))
        self.destination.SetHint('Enter a destination folder')
        self.destination.SetBackgroundColour('#ffffff')
        ...
        self.choose = wx.Button(self.panel, label='Choose directory', pos=(520, 40), size=(120, 25))
        self.choose.SetBackgroundColour('#e4dbe2')
        self.choose.SetForegroundColour('#000000')
        ...
        self.link = wx.TextCtrl(self.panel, pos=(10, 10), size=(500, 25))
        ...
        self.download = wx.Button(self.panel, label='Download', pos=(520, 10), size=(120, 25))
        self.download.SetBackgroundColour('#e4dbe2')
        self.download.SetForegroundColour('#000000')
        ...
        self.gif = wx.adv.AnimationCtrl(self.panel, pos=(10, 70), size=(10, 10))
...
class MyApp(wx.App):
    ...
    def OnInit(self):
        self.frame = MyFrame(None, title='wxPython')
        self.frame.Show()
        return True
